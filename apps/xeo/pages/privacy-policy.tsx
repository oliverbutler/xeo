  ...
  return (
    <Content className="my-10">
      <div className="tab-content translations-content-item en visible" id="en">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Xeo.
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>Google (if used for sign up)</li>
          <li>Github (if used for sign up)</li>
        </ul>
        <p>
          If You decide to register through or otherwise grant us access to a
          Third-Party Service, We may collect Personal data that is already
          associated with Your Third-Party Social Media Service's account, such
          as your name, your email address.
        </p>
        <p>
        ...
        <h3>Information from the Notion API</h3>
        <p>
          If you connect to Notion we store your secret key you provided,
          deletion of your Notion connection will delete the key from our
          Database.
        </p>
        <p>
          We only use the key you provided to retrieve data from the Table you
          selected to populate the sprint data and store history.
        </p>
        ...
        <ul>
          <li>By email: dev@oliverbutler.uk</li>
        </ul>
      </div>
    </Content>
  );
